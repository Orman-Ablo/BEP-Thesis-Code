function params = set_parameters_xy_corner_spots
% This function sets the parameters for the synthetic data generation with
% spots distributed over the FOV with aberrations according to NAT
...
% fitting parameters
params.nr_of_parallel_workers = 2; % Number of workers in parallel pool.
params.Nitermax = 10; % what is this? 60, 50 or 30
params.tollim = 1e-6;
params.varfit = 0;
...
params.NA = 1.5; % Numerical Aperture objective
...
params.fwd = 2000e3;
params.depth = 90;%?
params.zrange = [-700,700];  % in nm
params.zspread = [-700,700];
params.ztype =  'stage'; %'stage' 'medium'
params.lambda = 596;
...
params.yemit = 0.0;
params.zemit = 0.0;
params.Npupil = 42;% what is the relationship between Npupil and Mx 
params.pixelsize = 100; % nm
...
% model parameters
% what is this?
params.alpha = 0; %3.1416 or 0?
params.beta = 0;
params.K = params.Mz;%params.Mz;
params.m = 1;%0.95 or 1?
params.excitation = 'constant'; %'zstack' 'constant';
