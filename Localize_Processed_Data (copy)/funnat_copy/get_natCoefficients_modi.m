...
for nn = 1:Ncfg
    ...
    M1 = [0 x(2)*y(1)+y(3) x(3)+x(1)*y(2) x(2)+y(2) 0 ...
        x(1)*y(2)-x(3) 2*x(1)*y(2) y(1) -x(1) 2*x(1)*y(1) ...
        x(1) y(1) 1 0];
    M2 = [0 -x(3)-x(1)*y(2) x(2)*y(1)+y(3) 0 x(2)+y(2) ...
   ...
   % M2 = [y(4)-x(4) -x(3)-x(1)*y(2) x(2)*y(1)+y(3) 0 x(2)+y(2) ...
    ...
    M1 = [ 0 x(2) x(1)*y(1) x(1) x(2)+y(2) 0 y(1) x(1) 1 0];
    M2 = [0 x(1)*y(1) y(2) y(1) 0 x(2)+y(2) x(1) -y(1) 0 1];
