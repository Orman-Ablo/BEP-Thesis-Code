%% edit 'localize' to work with the OTF!
...
path_aberrations = "C:\Users\Naam\Documents\BEP\BEP Code Roman\Data_BEP_Roman\All_files_data\OTF_PSF_file.mat";%OTF
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Either Re-scale the limits of the OTF across the entire FOV, or leave out the previously listed outliers!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for file_i=5:7%nr_of_files
    ...
    for batch = 1:Nbatch
        ...
        if params.cpp
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % 
            theta_init_batch = initialvalues_phasor2(spots_batch,roixy_batch,theta_global,params,OTF_3d);
            %theta_init_batch = initialvalues_phasor3(spots_batch,roixy_batch,theta_global,params);
