...
%% Implement this to properly scale the PSF intensity!
%% This uses the summed intensities as a relative scale for the final PSF (and derivatives) size!
pos = params.pos;
z_emit = params.zemit/19;
val = interp1(pos, intensity, z_emit, 'linear', 'extrap');
scale = val/sum(PSF,'all');


PSF = PSF*scale;
PSFder(:,:,1,1:3) = PSFder(:,:,1,1:3)*scale;
