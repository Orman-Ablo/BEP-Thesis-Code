...
% Z(5,6)
prediction(:,1) =  RAstig3(8)*yn - RAstig3(9).*xn  +...
    RAstig3(11)*xn+RAstig3(12)*yn+RAstig3(13);

prediction(:,2) = RAstig3(8).*xn+...
    RAstig3(9)*yn+RAstig3(11)*yn-...
    RAstig3(12)*xn+RAstig3(14);

% Z(7,8)
prediction(:,3) = RComa3(4)*xn+RComa3(7)*yn+RComa3(8)*xn+RComa3(9);
prediction(:,4) = RComa3(4)*yn+RComa3(7)*xn-RComa3(8)*yn+RComa3(10);
