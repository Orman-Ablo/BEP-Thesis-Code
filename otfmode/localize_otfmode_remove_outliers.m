    ...
    for batch = 1:Nbatch
        ...
        if params.cpp
            ...
            params.Mpsfz = size(PSFmodelmatrix,3);
                ...
                local_update_otfmode(theta_init_batch,thetastore_local,meritstore_local,alambda_local,spots_batch,roixy_batch,iiter_total,Niters_batch,flip_z_net,framelist(start+1:stop),ID(start+1:stop),OTF_3d,params); 
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            else
